<?php
	...
	{
		header('Location:'. $site_path.'admin/dashboard.php');
        exit();
	}
    ...
    if( $_SERVER['REQUEST_METHOD'] == 'POST' )
    {
        ...
        $query = "SELECT userId FROM users WHERE username = '$uid' AND password = '$pass' AND userType = 'admin'";
                ...
                <div class="row">
                    <div class="contentWrapper">
                        <form method="post" action="<?PHP $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" novalidate>
                            <h3 style="text-align: center; font-size: 18px; padding: 5px;">Admin Login</h3>
